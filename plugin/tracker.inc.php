...
function plugin_tracker_list_action()
{
	...
	return array(
		'msg' => $qm->m['plg_tracker']['list'],
		'body' => str_replace('$1', $s_page, $qm->m['plg_tracker']['back']) .
...
class Tracker_list
{
	...
	function replace_item($arr)
	{
		...
		if (
			array_key_exists($style, $this->items)
