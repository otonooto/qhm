...
if (
    isset($vars['plugin']) && $vars['plugin'] == 'qhmsetting' &&
...
if (
    isset($vars['plugin']) ??
    $vars['plugin'] == 'qhmsetting' || $vars['cmd'] == 'qhmsetting'
) {
    return;
};
...
';
        ...
        $addclass = '';
        //プレビューならクラスを付ける
        if (isset($vars['preview']) ?? $vars['preview'] && $vars['page'] == $menubar) {
...
EOD;
        ...
        if (exist_plugin_convert('menu2')) {
            ...
            //プレビューならクラスを付ける
            $addclass = '';
            if (isset($vars['preview']) ?? $vars['preview'] && $vars['page'] == $menubar2) {
                $addclass = ' preview_highlight';
            }
...
EOD;
    ...
    if (exist_plugin_convert('nav2')) {
        ...
        //プレビューならクラスを付ける
        if (isset($vars['preview']) ?? $vars['preview'] && $vars['page'] == 'SiteNavigator2') {
    ...
    if (exist_plugin_convert('header')) {
        ...
        //プレビューならクラスを付ける
        if (isset($vars['preview']) ?? $vars['preview'] && $vars['page'] == 'SiteHeader') {
